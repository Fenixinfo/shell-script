...
DATA=`date +%d`
HORA=`date +%H:%M:%S`
RAIZ='/mnt/dados/backup-clientes/fenix/master/anual'
DIARIO='/mnt/dados/backup-clientes/fenix/master/anual/completo'
B1='/mnt/dados/geral'
B2='/mnt/dados/admin'
B3=''
LOG='/mnt/dados/backup-clientes/fenix/master/anual/log'
CL='FENIX MASTER'
#======================================================================
...
#============= LOG E-MAIL ============================================
echo "########### BACKUP ANUAL SERVIDOR $CL ###########" >> "$LOG"/"$DATA"_mail.log
...
mutt -s "$CL BACKUP ANUAL" fenixinformatic@gmail.com < "$LOG"/"$DATA"_mail.log
