...
DATA=`date +%d`
HORA=`date +%H:%M:%S`
RAIZ='/mnt/dados/backup-clientes/protec/diario'
DTN='/mnt/dados/backup-clientes/protec/diario'
B1='ls -1trap F* | grep -v '/$' | tail -n 1'
LOG='/mnt/dados/backup-clientes/protec/diario/log'
CL='FENIX DADOS RECEBIDOS PROTEC'
