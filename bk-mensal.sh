...
DATA=`date +%d`
HORA=`date +%H:%M:%S`
RAIZ='/mnt/dados/backup-clientes/fenix/master/mensal'
DIARIO='/mnt/dados/backup-clientes/fenix/master/mensal/completo'
B1='/mnt/dados/geral'
B2='/mnt/dados/admin'
B3=''
LOG='/mnt/dados/backup-clientes/fenix/master/mensal/log'
CL='FENIX MASTER'
#======================================================================
...
#============= LOG E-MAIL ============================================
echo "########### BACKUP MENSAL SERVIDOR $CL ###########" >> "$LOG"/"$DATA"_mail.log
...
mutt -s "$CL BACKUP MENSAL" fenixinformatic@gmail.com < "$LOG"/"$DATA"_mail.log
