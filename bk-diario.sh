...
DATA=`date +%d`
HORA=`date +%H:%M:%S`
RAIZ='/mnt/dados/backup-clientes/fenix/master/diario'
DIARIO='/mnt/dados/backup-clientes/fenix/master/diario/completo'
B1='/mnt/dados/geral'
B2='/mnt/dados/admin'
B3=''
LOG='/mnt/dados/backup-clientes/fenix/master/diario/log'
CL='FENIX MASTER'
#======================================================================
